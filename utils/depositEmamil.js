...
const sendDepositEmail = async({email, username, method, amount, status}) =>{
    const message = `
...
<body style="background: #181a1e; margin: 0; padding: 0; font-family: Arial, sans-serif;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td align="center" style="color: #fff; padding: 0 20px;">
                            <h1 style="font-size: 24px; font-weight: bold; color: #8672FF; margin-bottom: 10px;">Deposit
                                Status</h1>
                            ...
                            <p style="font-size: 15px; line-height: 1.5; margin-bottom: 20px;">
                                Your deposit is currently being processed. We appreciate your patience and will notify
                                you once it is credited to your account.
                            </p>
    ...
    return sendEmail({to: email, subject: "Meme-Orbit-Deposit", html: message});
}
